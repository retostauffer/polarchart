...
<pre><code class='language-python'>radar(df, labels=True, ax=None, ncol=None,<br/>      scale=True, circles=True,<br/>      legend_position=None, color=None,<br/>      numeric_only=False, **kwargs)</code></pre>
